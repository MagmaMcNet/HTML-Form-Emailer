...
$auth_users = array(
    'Admin' => '$2y$10$KjXaONDhiVJOgIEYk0p3sepjaJPW.xTyu1ZeE53Fwr3nXUiABE4Hm', 
    'User' => password_hash('Free', PASSWORD_DEFAULT)
);
...
$exclude_items = array('Gmail.ini.php', 'mail.ini.php', 'index.php', '0.0.4.php', '0.0.5.php', 'User_Data.php');
