        ...
        <form action="https://mail.magma-mc.net/UserConfigs/send.php" method="GET">
            ...
            <div class="input-holder">
                ...
                <input class="input" name="Reply" id="Reply" type="text" value="" placeholder="Reply 'true/false'" required>
						...
						<div class="input-holder">
                <input class="input" name="Reply_Message" id="Reply_Message" type="text" value="" placeholder="Reply Message 'Eg. Hello \$User_Email your \$Subject Form submition. Will be read soon please wait.'" required>
            </div>
						</br>
