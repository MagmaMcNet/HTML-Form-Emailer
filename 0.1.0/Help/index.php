...
<html lang="en">
	...
	<body>
		<form action="https://<?php echo $_SERVER['HTTP_HOST'];?>" method="POST">
			<div class="input-holder">
			...
			<div id="ES">
				<input name="EmailService[ID]" type="hidden" value="ID/FILENAME"> <!-- Eg _BASE_/Test_MailService-->
			</div>
